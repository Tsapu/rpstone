...
void executeTemotoAction()
{
  ...
  twist_msg.linear.x = in_param_linear_velocity_x;
  twist_msg.linear.y = in_param_linear_velocity_y;
  twist_msg.angular.z = in_param_angular_velocity_z;

  while (actionOk())
  {
    rmi_.publishVelocity(in_param_robot_name, twist_msg);
